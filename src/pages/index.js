...
const IndexPage = () => (
  <Layout>
    <SEO title="Twitter Analytics, Simplified - Myna.One" />

    <div className={"page-header home"}>
      <h1>Twitter Analytics, Simplified.</h1>
      <p>
        Myna simplifies your Twitter Analytics 
        <br />
        and lets you concentrate on growing your audience.
      </p>
