            ...
            <div className={"row"}>
              <div className={"col-5"}>
                ...
                **/}
                 <div className={"widget__item"}>
                  <div className={"links"}>
                    <h4>Learn Twitter Data Analysis</h4>
                    <ul>
                      <li>
                        <Link to="/blog/twitter-data-analysis-python/" title={"Analyze Twitter Data with Python"}>
                          Analyze Twitter Data with Python
                        </Link>
                      </li>
              ...
              <div className={"col-3"}>
                <div className={"widget__item"}>
                  <div className={"social"}>
                    <a
                      href="https://twitter.com/mynaone"
                      target={"_blank"}
                      title={"Twitter"}
                    >
